...
export const ACTIVITIES = [
    {
        ...
        location: "Teneife, Islas Canarias, España",
        difficulty: "Alta",
    ...
    {
        name: "El Camino del Barranco de Masca",
        location: "Tenerife, Islas Canarias, España",
        difficulty: "Media",
        schedule: "Lunes a Domingo: 7:00 AM - 7:00 PM",
        generalRating: 4.7,
        popularity: 92,
        amenities: [
    ...
    {
        name: "Tenerife: Atardecer y observación de estrellas en el Parque Nacional del Teide",
        location: "Tenerife, Islas Canarias, España",
        difficulty: "Baja",
        schedule: "Lunes a Domingo: 8:00 PM - 1:00 AM",
        generalRating: 4.8,
        popularity: 95,
        amenities: [
            "Visitas guiadas",
